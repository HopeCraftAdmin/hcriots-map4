...
import net.hcriots.hcf.faction.event.CaptureZoneEnterEvent;
import net.hcriots.hcf.faction.event.CaptureZoneLeaveEvent;
...
import net.hcriots.hcf.faction.type.*;
...
public class ProtectionListener implements Listener {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        if (HCF.getInstance().getFactionManager().getFactionAt(event.getPlayer().getLocation()) == HCF.getInstance().getFactionManager().getFaction("GlowstoneMountain")){
