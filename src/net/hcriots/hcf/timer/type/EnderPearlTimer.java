    ...
    public void onProjectileLaunch(ProjectileLaunchEvent event) {
        ...
        if (projectile instanceof EnderPearl) {
            ...
            if (source instanceof Player) {
                ...
                if (remaining > 0L) {
                    shooter.sendMessage(ChatColor.RED + "You are still on " + ChatColor.DARK_PURPLE + getName() + ChatColor.RED + " cooldown for another " + ChatColor.BOLD
        ...
        public void run() {
            ...
            if (stack != null && stack.getType() == Material.ENDER_PEARL) {
                ...
                if (remaining > 0L) {
                    ...
                    item.c(ChatColor.DARK_PURPLE + "Enderpearl Cooldown" + ChatColor.GRAY + " : " + ChatColor.WHITE + DurationFormatter.getRemaining(remaining, true, true));
