...
import com.hcriots.utils.MapSorting;
...
public class FactionListArgument extends CommandArgument {
    ...
    private void showList(final int pageNumber, final String label, final CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.GOLD + " You are currently on " + ChatColor.YELLOW + "Page " + pageNumber + '/' + maxPages + ChatColor.GOLD + '.');
        sender.sendMessage(ChatColor.GOLD + " To view other pages, use " + ChatColor.YELLOW + '/' + label + ' ' + this.getName() + " <page#>" + ChatColor.GOLD + '.');
        sender.sendMessage(ChatColor.GRAY + BukkitUtils.STRAIGHT_LINE_DEFAULT);
    }
}
